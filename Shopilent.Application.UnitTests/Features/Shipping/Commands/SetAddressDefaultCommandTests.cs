...
namespace Shopilent.Application.UnitTests.Features.Shipping.Commands;

public class SetAddressDefaultCommandTests : TestBase
{
    private readonly IMediator _mediator;
    
    public SetAddressDefaultCommandTests()
    {

...
namespace Shopilent.Application.UnitTests.Features.Shipping.Queries;

public class GetUserAddressesQueryHandlerTests : TestBase
{
    ...
    public async Task Handle_WithAddressesHavingPhoneNumbers_ReturnsAddressesWithPhones()
    {
        ...
        var addresses = new List<AddressDto>
        {
            CreateTestAddressDto(Guid.NewGuid(), userId, AddressType.Shipping, true, "123 Main St", "New York", "+15551234567"),
            CreateTestAddressDto(Guid.NewGuid(), userId, AddressType.Billing, false, "456 Oak Ave", "Los Angeles", null) // No phone
        };

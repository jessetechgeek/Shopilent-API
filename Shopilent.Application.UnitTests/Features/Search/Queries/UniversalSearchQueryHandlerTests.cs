...
namespace Shopilent.Application.UnitTests.Features.Search.Queries;

public class UniversalSearchQueryHandlerTests : TestBase
{
    private readonly UniversalSearchQueryHandlerV1 _handler;

    public UniversalSearchQueryHandlerTests()
    {

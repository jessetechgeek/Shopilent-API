...
namespace Shopilent.Application.UnitTests.Features.Payments.Commands;

public class SetDefaultPaymentMethodCommandTests : TestBase
{
    private readonly IMediator _mediator;

    public SetDefaultPaymentMethodCommandTests()
    {

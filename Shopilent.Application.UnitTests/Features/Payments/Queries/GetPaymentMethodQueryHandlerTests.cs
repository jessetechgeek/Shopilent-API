...
namespace Shopilent.Application.UnitTests.Features.Payments.Queries;

public class GetPaymentMethodQueryHandlerTests : TestBase
{
    private readonly IMediator _mediator;

    public GetPaymentMethodQueryHandlerTests()
    {

...
public class PaymentWriteRepositoryTests : IntegrationTestBase
{
    ...
    public async Task AddAsync_ValidPayment_ShouldPersistPayment()
    {
        ...
        // Assert
        var result = await _unitOfWork.PaymentWriter.GetByIdAsync(payment.Id);
    ...
    public async Task UpdateAsync_ValidPayment_ShouldUpdatePayment()
    {
        ...
        var existingPayment = await _unitOfWork.PaymentWriter.GetByIdAsync(payment.Id);
        var transactionId = "txn_updated_123";
        existingPayment!.MarkAsSucceeded(transactionId);

        // Act
        await _unitOfWork.PaymentWriter.UpdateAsync(existingPayment);
        await _unitOfWork.SaveChangesAsync();
    ...
    public async Task DeleteAsync_ExistingPayment_ShouldRemoveFromDatabase()
    {
        ...
        // Act
        await _unitOfWork.PaymentWriter.DeleteAsync(payment);
        await _unitOfWork.SaveChangesAsync();
    ...
    public async Task GetByIdAsync_NonExistentPayment_ShouldReturnNull()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByIdAsync(nonExistentId);
    ...
    public async Task GetByTransactionIdAsync_ExistingPayment_ShouldReturnPayment()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByTransactionIdAsync(transactionId);
    ...
    public async Task GetByTransactionIdAsync_NonExistentTransaction_ShouldReturnNull()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByTransactionIdAsync(nonExistentTransactionId);
    ...
    public async Task GetByExternalReferenceAsync_ExistingPayment_ShouldReturnPayment()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByExternalReferenceAsync(externalReference);
    ...
    public async Task GetByExternalReferenceAsync_NonExistentReference_ShouldReturnNull()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByExternalReferenceAsync(nonExistentReference);
    ...
    public async Task GetByOrderIdAsync_ExistingPayments_ShouldReturnPayments()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByOrderIdAsync(order.Id);
    ...
    public async Task GetByOrderIdAsync_NonExistentOrder_ShouldReturnEmpty()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByOrderIdAsync(nonExistentOrderId);
    ...
    public async Task GetByStatusAsync_ExistingPayments_ShouldReturnFilteredPayments()
    {
        ...
        var pendingResults = await _unitOfWork.PaymentWriter.GetByStatusAsync(PaymentStatus.Pending);
        ...
        var succeededResults = await _unitOfWork.PaymentWriter.GetByStatusAsync(PaymentStatus.Succeeded);
        ...
        var failedResults = await _unitOfWork.PaymentWriter.GetByStatusAsync(PaymentStatus.Failed);
    ...
    public async Task GetByStatusAsync_NoPaymentsWithStatus_ShouldReturnEmpty()
    {
        ...
        // Act
        var result = await _unitOfWork.PaymentWriter.GetByStatusAsync(PaymentStatus.Refunded);
    ...
    public async Task OptimisticConcurrencyControl_ConcurrentUpdates_ShouldHandleCorrectly()
    {
        ...
        var payment1 = await unitOfWork1.PaymentWriter.GetByIdAsync(payment.Id);
        var payment2 = await unitOfWork2.PaymentWriter.GetByIdAsync(payment.Id);
        ...
        await unitOfWork1.PaymentWriter.UpdateAsync(payment1);
        await unitOfWork1.SaveChangesAsync();

        // Second update should handle concurrency properly
        await unitOfWork2.PaymentWriter.UpdateAsync(payment2);
        ...
        // Verify final state
        var finalPayment = await _unitOfWork.PaymentWriter.GetByIdAsync(payment.Id);
    ...
    public async Task BulkOperations_MultiplePayments_ShouldHandleCorrectly()
    {
        ...
        // Verify bulk updates
        var succeededPayments = await _unitOfWork.PaymentWriter.GetByStatusAsync(PaymentStatus.Succeeded);
    ...
    public async Task PaymentRefund_WorkFlow_ShouldUpdateCorrectly()
    {
        ...
        var paymentToRefund = await _unitOfWork.PaymentWriter.GetByIdAsync(payment.Id);
        paymentToRefund!.MarkAsRefunded("refund_txn_123");

        // Act
        await _unitOfWork.PaymentWriter.UpdateAsync(paymentToRefund);
        await _unitOfWork.SaveChangesAsync();
